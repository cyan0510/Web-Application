...
function create_new_user(){
    ...
    $password = md5($_POST['password']); // Add MD5 encryption
    $confirmpassword = md5($_POST['confirmpassword']); // Add MD5 encryption
...
function change_user_password(){
    ...
    $new_password = md5($_POST['npassword']); // Add MD5 encryption
    $confirm_password = md5($_POST['copassword']); // Add MD5 encryption
