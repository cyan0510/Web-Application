...
<body>
  ...
  <div class="nav">
    ...
    <li><a href="index.php?page=sales">Order</a></li>
    <li><a href="index.php?page=settings">Settings</a> <a id="logout" href="logout.php">Log Out</a></li>
	<span id="user" style="color:white;" class="move-right"><?php echo $user->get_user_lastname($user_id).', '.$user->get_user_firstname($user_id);?>&nbsp;&nbsp; &nbsp;&nbsp;</span>
		</ul>
  </div>
